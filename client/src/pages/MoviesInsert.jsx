        ...
        <Container>
          <Row>
            <Col>
              ...
              <ul>
                { results.map((app, i) => { return <li key={i}><img src={app.icon} width='50' height='50' alt="test" /><button key={i} onClick={this.handleChangeAppSelect(app)}>{ app.title }</button></li> })}
              </ul>
            </Col>
